...
\lstset{
	...
	tabsize=2,
	captionpos=t, % Позиция подписи (b - снизу, t - сверху)
	morekeywords={SERIAL, PRIMARY, KEY, REFERENCES, integer, varchar, if} % Добавьте больше ключевых слов PostgreSQL, если нужно
}
